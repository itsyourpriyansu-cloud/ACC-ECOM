...
export const seed = async ({
  ...
  const pendingTransaction = await payload.create({
    ...
    data: {
      ...
      phonepe: {
        merchantOrderID: 'demo-phonepe-pending',
        phonePeTransactionID: 'demo-payment-pending',
      },
      status: 'pending',
  ...
  const succeededTransaction = await payload.create({
    ...
    data: {
      ...
      paymentMethod: 'phonepe',
      phonepe: {
        merchantOrderID: 'demo-phonepe-succeeded',
        phonePeTransactionID: 'demo-payment-succeeded',
      },
      status: 'succeeded',
      billingAddress: baseAddressUSData,
    },
