...
export interface Order {
  ...
  /**
   * After payment is confirmed, tick this and save to create the shipment in Shiprocket.
   */
  sendToShiprocket?: boolean | null;
...
export interface Product {
  ...
  title: string;
  /**
   * Internal product code used for inventory and catalogue reconciliation.
   */
  sku: string;
  /**
  ...
  catalogue?: {
    ...
    /**
     * Temporary stock visual for storefront previews. Replace with approved product photography before launch.
     */
    visual?: {
      /**
       * External image URL used by the storefront.
       */
